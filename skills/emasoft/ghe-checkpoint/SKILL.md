---
name: ghe-checkpoint
description: "POST a progress checkpoint to the currently active thread. Saves work state without changing phases. Use to save progress, record milestones, or document blockers. Requires an already-claimed in-progress thread."
---
