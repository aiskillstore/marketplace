...
description: |
  ...
  USE THIS SKILL WHEN:
  - User asks "what's the status" or wants workflow overview
  - User asks "what threads are active" or "what am I working on"
  - User wants quick overview before starting work or at session start

  DO NOT USE THIS SKILL WHEN:
  - User wants to CLAIM, CHECKPOINT, or TRANSITION issues (use ghe-claim, ghe-checkpoint, ghe-transition)
  - User wants DETAILED metrics/reports (use ghe-report)
---
