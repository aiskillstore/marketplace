---
name: ghe-transition
description: "Transitions GitHub Elements workflow phases by closing current thread and opening the next. Use for DEV→TEST, TEST→REVIEW, REVIEW→merge, or demotions. Not for saving progress without changing phases."
---
