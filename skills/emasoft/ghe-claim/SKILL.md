---
name: ghe-claim
description: "Claim a GitHub issue to start working on it. Validates the issue, performs atomic claim, posts claim comment, and sets up git worktree. Use when user says 'claim issue #N' or similar."
---
