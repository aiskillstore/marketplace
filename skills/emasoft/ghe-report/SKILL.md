---
name: ghe-report
description: "Generate detailed GitHub Elements reports with metrics, health checks, or epic-specific analysis. Report types: metrics (throughput, cycle times, first-pass rates, demotion rates), health (compliance, stale threads, violations), and epic (thread history, progress, decisions). Use for performance analysis, compliance audits, or epic deep dives. More comprehensive than ghe-status for quick overviews."
---
