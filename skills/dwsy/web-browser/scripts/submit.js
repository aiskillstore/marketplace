...
if (!selector) {
  console.log("Usage: submit.js <selector>");
  console.log("\nExamples:");
  console.log('  submit.js "form"');
  console.log('  submit.js "#login-form"');
  console.log('  submit.js ".search-form"');
  process.exit(1);
}
...
try {
  ...
  await p.$eval(selector, (form) => form.submit());
  console.log(`✓ Submitted: ${selector}`);
} catch (error) {
  console.error(`✗ Failed to submit: ${selector}`);
