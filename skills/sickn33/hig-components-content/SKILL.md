...
version: 1.0.0
description: "Apple Human Interface Guidelines for content display components including charts, collections, image views, web views, color wells, image wells, activity views, and lockups."
risk: unknown
source: community
---
