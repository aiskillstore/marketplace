...
name: hig-patterns
version: 1.0.0
description: "Apple Human Interface Guidelines interaction and UX patterns for onboarding, loading, drag and drop, search, settings, notifications, modality, multitasking, feedback, haptics, undo/redo, file management, data entry, sharing, collaboration, full screen, audio, video, ratings, printing, help, and account management."
risk: unknown
source: community
---
