...
version: 1.0.0
description: Apple HIG guidance for menu and button components including menus, context menus, toolbars, action buttons, pop-up buttons, and disclosure controls.
risk: unknown
source: community
---
