...
version: 1.0.0
description: 'Apple HIG guidance for navigation-related components including search fields, page controls, and path controls. Use for search UX, pagination, breadcrumbs, and hierarchical navigation questions.'
risk: unknown
source: community
---
