...
version: 1.0.0
description: "Apple HIG guidance for navigation components including search fields, page controls, path controls, and breadcrumbs. Use when asking about search UX, pagination, or file path hierarchy."
risk: unknown
source: community
---
