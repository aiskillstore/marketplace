...
description: "Export OpenTelemetry traces, metrics, and logs to Azure Monitor/Application Insights for Java. Note: This package is DEPRECATED. Migrate to azure-monitor-opentelemetry-autoconfigure."
