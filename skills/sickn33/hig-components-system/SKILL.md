...
description: "Apple HIG guidance for system experience components: widgets, live activities, notifications, complications, quick actions, top shelf, watch faces, app clips, and shortcuts."
---
