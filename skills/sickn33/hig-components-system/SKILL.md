...
description: "Apple HIG guidance for system experience components: widgets, live activities,\
  ...
  surfaces outside the main app. Cross-references: hig-components-status for progress in\
  widgets, hig-inputs for interaction patterns, hig-technologies for Siri and system integration."
risk: unknown
source: community
---
