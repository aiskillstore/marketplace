...
description: "Routes RunComfy music requests to ElevenLabs Music or ACE Step models, preparing CLI commands for vocal songs, instrumentals, multilingual tracks, audio inpainting, and outpainting."
