...
description: "Route RunComfy music requests to ElevenLabs or ACE Step models and prepare CLI commands for vocal songs, instrumentals, multilingual tracks, audio inpainting, and outpainting."
