...
description: "Route AI music generation and editing requests to RunComfy models, with commands for vocal songs, instrumentals, multilingual tracks, audio inpainting, and outpainting."
