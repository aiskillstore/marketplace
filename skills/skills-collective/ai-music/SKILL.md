...
description: "Route AI music generation and editing requests to RunComfy models, preparing commands for vocals, instrumentals, multilingual songs, inpainting, and outpainting."
