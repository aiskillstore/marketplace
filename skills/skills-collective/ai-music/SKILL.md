...
description: "Route RunComfy AI music requests to ElevenLabs or ACE Step for vocal songs, instrumentals, multilingual tracks, time-range inpainting, and bidirectional outpainting. Provides model selection and runcomfy CLI commands."
