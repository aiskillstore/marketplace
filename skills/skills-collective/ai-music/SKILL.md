...
description: "Route AI music generation and editing requests to RunComfy models, with commands for vocals, instrumentals, multilingual songs, audio inpainting, and outpainting."
