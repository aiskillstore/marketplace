...
description: "Route RunComfy music requests to ElevenLabs or ACE Step for vocal songs, instrumentals, multilingual tracks, audio inpainting, and outpainting. Provides model-specific prompting and runcomfy CLI commands."
