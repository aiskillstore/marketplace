...
description: "Route AI music generation and editing requests to RunComfy models, preparing CLI commands for vocal songs, instrumentals, multilingual music, audio inpainting, and outpainting."
