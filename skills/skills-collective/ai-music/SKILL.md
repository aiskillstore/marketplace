...
description: "Generate or edit AI music with RunComfy's CLI. Routes requests to ElevenLabs Music or ACE Step models for premium or cost-sensitive songs, multilingual vocals, time-range repairs, and track extensions."
