...
description: "Route AI music generation and audio editing to RunComfy models. Prepare CLI commands for premium or cost-effective vocal songs, instrumentals, multilingual tracks, time-range inpainting, and bidirectional outpainting."
