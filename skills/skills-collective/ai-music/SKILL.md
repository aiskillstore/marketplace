...
description: "Route RunComfy music requests to ElevenLabs or ACE Step, preparing CLI commands for vocal songs, instrumentals, multilingual tracks, time-range inpainting, and audio outpainting."
