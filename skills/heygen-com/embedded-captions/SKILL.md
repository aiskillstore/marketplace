...
description: 'Add rail, embedded, or VFX-themed captions to single-subject talking-head videos using local transcription, matting, identity selection, preview QA, and hyperframes rendering.'
metadata:
