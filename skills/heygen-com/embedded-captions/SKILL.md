...
description: 'Add embedded or rail captions to single-subject talking-head videos using a catalog of cinematic and themed identities with local transcription, matting, preview, and render scripts.'
metadata:
