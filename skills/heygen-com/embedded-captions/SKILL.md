...
description: 'Add cinematic embedded captions or readable lower-third rails to single-subject talking-head videos. Pick one visual identity from CATALOG.md, transcribe and matte locally with hyperframes, preview for visual QA, then render captions composited with subject occlusion.'
metadata:
