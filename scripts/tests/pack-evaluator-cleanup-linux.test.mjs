...
test('linux bash cleanup publishes diagnostics before bounded process-tree termination', {
  ...
  writeFileSync(harnessScript, [
    ...
    'CLAUDE_PREFLIGHT_STDOUT="$GITHUB_WORKSPACE/claude-preflight.stdout"',
    'CLAUDE_PREFLIGHT_STDERR="$GITHUB_WORKSPACE/claude-preflight.stderr"',
    'CODEX_PREFLIGHT_STDOUT="$GITHUB_WORKSPACE/codex-preflight.stdout"',
    'CODEX_PREFLIGHT_STDERR="$GITHUB_WORKSPACE/codex-preflight.stderr"',
    ': > "$PROXY_LOG"',
    ': > "$PROXY_ACTIVITY"',
