...
AI Skillstore marketplace v0.3.0 expands the catalog to 26 total plugins, adding 38 new plugins that broaden support for agent/command and skill development, MCP integration and builder tooling, frontend/design workflows, and common document formats (PDF, DOCX, PPTX, XLSX). Users get more ready-to-use building blocks for creating, testing, and packaging skills and integrations with less setup and fewer bespoke components. 
...
AI Skillstore marketplace v0.2.0 expands the catalog with 38 newly added plugins across agent/command development, MCP integration, and practical content and document workflows (PDF/DOCX/PPTX/XLSX), improving the range of tasks users can solve end-to-end. The marketplace now offers 26 total plugins, giving users broader, more specialized building blocks for creating, testing, and operating skills and web artifacts. 
