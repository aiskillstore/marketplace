...
AI Skillstore marketplace v0.4.1 expands the catalog to 413 plugins with 129 new additions spanning research, docs, design, dev workflows, and evaluation. It also improves reliability with fixes to AUTO_FIX_ENABLED handling, a lead-research-assistant FAQ key correction, and more robust Skillstore CLI downloading (PAT_TOKEN auth, reusable action, and dynamic latest-version fetching). 
