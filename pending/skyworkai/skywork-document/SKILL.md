...
description: "Generate professional documents in multiple formats (docx, pdf, markdown, html) using the Skywork Office Doc API. Create documents from scratch or based on uploaded reference files. Automatically gathers up-to-date web content. Ideal for reports, proposals, blogs, papers, contracts, resumes, and any structured long-form output."
metadata:
  openclaw:
    requires:
      bins:
