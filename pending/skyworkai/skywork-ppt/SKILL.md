---
name: skywork-ppt
description: "Generate, edit, and manage PowerPoint presentations. Supports creating PPTs from topics, template-based generation, AI-powered editing via natural language, and local file operations (delete, reorder, merge, extract slides)."
metadata:
  openclaw:
    requires:
      bins:
