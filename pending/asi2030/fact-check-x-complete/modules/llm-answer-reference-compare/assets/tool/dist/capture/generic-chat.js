...
import { validateTrustedSearchEndpoint } from "../utils/trusted-search-endpoint.js";
...
async function extractTrustedSearchReference(reference, question = "") {
    ...
    const endpoint = validateTrustedSearchEndpoint(
        String(process.env.FACTCHECK_TRUSTED_SEARCH_URL || "https://open.dknowc.cn/dependable/search").trim()
    );
