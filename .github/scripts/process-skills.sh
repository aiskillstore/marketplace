...
$TRUST_SECTION"
  ...
  REQUEST_BODY=$(jq -n \
    ...
    '{model: $model, messages: [{role: "user", content: $content}], temperature: 0.3, max_tokens: 100000, response_format: $response_format}')
