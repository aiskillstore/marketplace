...
name: ghe-transition
description: |
  Changes phases in the GitHub Elements workflow by closing the current thread and opening the next phase thread. Use when user wants to END current phase and BEGIN next (e.g., "transition to TEST", "move to REVIEW", "demote to DEV", "merge this"). Do NOT use for status checks, claiming issues, saving progress, or generating reports.
---
